...
export const V5_PRODUCTION = {
  ...
  subtitle:
    "Создаём мебель от коллекции до индивидуального проекта на итальянском оборудовании. Полный цикл в Москве.",
  steps: [
    {
      num: "01",
      title: "Деревообработка",
      text: "Подбор пород и фактур под условия палубы и климата. Точная раскройка, шлифовка и подготовка несущих элементов. Контроль влажности и геометрии на каждом этапе.",
      image: YACHT_PRODUCTION_STEP_01,
    },
    {
      num: "02",
      title: "Металлообработка",
      text: "Каркасы и крепёж из коррозионностойких сплавов. Сварка, полировка и защитные покрытия под морскую среду. Соответствие нагрузкам и эстетике проекта.",
      image: YACHT_PRODUCTION_STEP_02,
    },
    {
      num: "03",
      title: "Пошив мягких элементов",
      text: "Ткани и наполнители с устойчивостью к UV и влаге. Индивидуальные чехлы, подушки и мягкие модули. Посадка и тактильный комфорт под сценарий отдыха.",
      image: YACHT_PRODUCTION_STEP_03,
    },
    {
      num: "04",
      title: "Финальная сборка",
      text: "Сборка модулей в московском цехе под ваш проект. Стыковка материалов, фурнитуры и декоративных деталей. Предмонтажная проверка перед отправкой на объект.",
      image: YACHT_PRODUCTION_STEP_04,
    },
    {
      num: "05",
      title: "Контроль качества",
      text: "Многоступенчатая приёмка каждого изделия. Проверка геометрии, креплений и внешнего вида. Документация и сопровождение до установки на яхте.",
      image: yachtImg(10),
    },
...
export const V5_VIZ = {
  ...
  title: "Покажем проект до начала производства",
  subtitle:
    "Будущий результат до запуска работ, для коллекции или индивидуального проекта.",
...
export const V5_COLLECTIONS = {
  ...
  items: [
    ...
    {
      name: "Лаундж",
      desc: "Жардин Кутюр: зелень и мягкие формы для lounge-зон на палубе с панорамным видом на море.",
