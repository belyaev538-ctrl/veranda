...
export function EditorialGrid() {
  ...
  return (
    <SectionAtmosphere
      id="projects"
      tone="cream"
      className="section-pad relative bg-cream"
    >
      <div className="container-luxury mb-8 flex flex-col gap-6 desktop:mb-10 desktop:flex-row desktop:items-end desktop:justify-between">
        <div>
          ...
          <ClipReveal as="p" className="mt-4 max-w-xl font-sans text-base text-muted" delay={0.14}>
            Решения для разных сценариев отдыха на борту.
          </ClipReveal>
        </div>

        <div className="flex items-center gap-3">
          <p className="hidden font-sans text-sm text-muted tablet:block">
      ...
      <div className="relative">
        <div className="strip-fade-cream-left pointer-events-none absolute inset-y-0 left-0 z-10 w-14 tablet:w-24" />
        <div className="strip-fade-cream-right pointer-events-none absolute inset-y-0 right-0 z-10 w-14 tablet:w-24" />

        <div
          ref={stripRef}
          onScroll={updateScrollState}
          className="projects-scroll flex snap-x snap-mandatory gap-4 overflow-x-auto overscroll-x-contain scroll-smooth pb-2 pl-5 pr-[12vw] scrollbar-hide tablet:gap-5 tablet:pl-8 tablet:pr-[10vw] desktop:gap-6 desktop:pl-12 desktop:pr-[8vw]"
        >
